...
fn main() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .header(format!("{}/verilog_preprocessor.h", c_src_dir))
        .clang_arg(format!("-I{}", c_src_dir))
        .allowlist_function("verilog_parser_init")
        .allowlist_function("verilog_preprocessor_set_file")
